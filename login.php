...
if(isset($_POST['login'])) {
  ...
  if(password_verify($pass, $cariuser['password'])){
    ...
    if($cariuser) {
      echo '<script>alert("Anda berhasil login sebagai ' . $cariuser['username'] . '");window.location="CRUD/index.php"</script>';  
    } else {
      ...
      <div class="authentication-inner">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="box">
		<div class="title-box">
		<h1><center>Bojonegoro Kec.Kepohbaru</center></h1>
		<p><center>Pendataan Penduduk <br> Desa Mudung</center></p>
	</div>
            <div class="app-brand justify-content-center">
              <a href="index.html" class="app-brand-link gap-2">
                <span class="app-brand-text demo text-body fw-bolder">dsn.mudung</span>
              </a>
            </div>
            <!-- /Logo -->
            <form method="POST">
